...
{/* <button className="mt-[11px] hover:border hover:border-[#8647F4] group hover:bg-[#fff] bg-[#8647F4]  border h-[43px] border-white rounded-md w-[125px] ">
  ...
  <div className=''>
    <img src="/Home/video_img.png" alt="home3" className="h-full" />
        ...
        <div className=" sm:flex hidden h-[29rem] relative">
          <div className="w-[60%] bg-[#111111] pl-[70px] pt-[80px] ">
            <p className="text-[40px] text-white capitalize font-semibold w-[90%] tracking-[0.2rem]">
            TURNING DREAMS INTO
            REALITY BEGINS HERE
            </p>
          <p className="text-white w-[60%] mt-[2rem]">
          ...
          <div className="w-[40%] bg-[#8647F4]"></div>
          <img src="/Home/cake.png" alt="" className="absolute top-20 right-20 w-[40%]"/>
        </div>
        <Footer/>
    </div>
  )
